...
public class VerticalAbsSeekBar extends VerticalProgressBar{
    ...
    public VerticalAbsSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VerticalAbsSeekBar(Context context, AttributeSet attrs, int defStyle) {
